...
class Contact_Form_Controller
{
    ...
    public function send_confirmation($email, $name)
    {
        ...
        try {
            ...
            $mail->setFrom('cristian.lafuente.martinez@gmail.com', 'Cristian Lafuente Martinez');     //Add a recipient
            //$mail->addAddress('ellen@example.com');               //Name is optional
            //$mail->addReplyTo('info@example.com', 'Information');
            //$mail->addCC('cc@example.com');
            //$mail->addBCC('bcc@example.com');
            ...
            $mail->isHTML(true);                                  //Set email format to HTML
            $mail->Subject = 'Contacto Web Portfolio';
            $mail->Body    = 'Muchas gracias por el interes ' . $name . ', en breve me pondré en contacto contigo! Un saludo';
